...
<bean:define name="BTables" property="nameTable" id="nameTable" type="java.lang.String" />
          ...
          <logic:notEmpty name="BRecordList2"> 
                    <bean:define name="BPaging2" id="beans" type="com.form.FBeans"/>
    <div  style=" DISPLAY: block;  BACKGROUND: White;  OVERFLOW: auto;  WIDTH: 950px; HEIGHT: 300px;">

        <table class="list-voffice" cellpadding="0" cellspacing="0" width="100%" border="0">
                <bean:define name="BRecordList2" id="recordList" type="java.lang.String[][]"/>
                <%
